            ...
            <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <Nav.Item as="li">
                    <Link to="/" className={`nav-link ${location.pathname === "/" ? "active" : ""}`}>
                        ...
                        <span className="item-name">MediXScan Dashboard</span>
                ...
                <Nav.Item as="li">
                    <Link
                        ...
                        <span className="item-name ">Medical Analytics Dashboard</span>
                ...
                <Nav.Item as="li">
                    <Link
                        ...
                        <span className="item-name ">Clinical Operations Dashboard</span>
                    </Link>
                </Nav.Item>
                <Nav.Item as="li">
                ...
                <Nav.Item as="li">
                    <Link
                        ...
                        <span className="item-name ">Health Monitoring Dashboard</span>
                    </Link>
                </Nav.Item>
                <li>
